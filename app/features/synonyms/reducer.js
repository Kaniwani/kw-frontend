...
export const synonymsUiReducer = handleActions(
  {
    [synonym.add.request]: () => ({ submitting: true }),
    [combineActions(synonym.add.success, synonym.add.failure)]: () => ({ submitting: false }),
  },
  initialUiState
);
