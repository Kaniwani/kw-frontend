...
describe('VOCABLEVELCONTAINER actions', () => {
  describe('defaultLoad', () => {
    it('has a type of APP/VOCABLEVELCONTAINER/DEFAULT/LOAD', () => {
  ...
  describe('defaultLoadSuccess', () => {
    it('it has a type of APP/VOCABLEVELCONTAINER/DEFAULT/SUCCESS', () => {
      expect(defaultLoadSuccess()).toEqual({ type: TYPES.DEFAULT.SUCCESS });
    });
  });
  describe('defaultLoadFailure', () => {
    it('it has a type of APP/VOCABLEVELCONTAINER/DEFAULT/FAILURE', () => {
      expect(defaultLoadFailure()).toEqual({ type: TYPES.DEFAULT.FAILURE });
    });
  });
  describe('defaultLoadCancel', () => {
    it('it has a type of APP/VOCABLEVELCONTAINER/DEFAULT/CANCEL', () => {
