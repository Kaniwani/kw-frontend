...
const testPatterns = [
  [
    { reading: 'な', pitchNum: 0 },
    { reading: 'き', pitchNum: 1 }],
  [
...
describe('PitchDiagram utils', () => {
  ...
  describe('getMoraCount()', () => {
    ...
    it('returns mora length of pre-split array', () => expect(getMoraCount(['ちゅ', 'う', 'が', 'っ', 'こ', 'う'])).toEqual(6));
    it('returns mora length of unsplit string', () => expect(getMoraCount('ちゅうがっこう')).toEqual(6));
  });
