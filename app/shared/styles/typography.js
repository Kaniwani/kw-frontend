...
export const maxFontRange = 1400; // stop scaling
...
export const giga = fluidType(22, 50, 300, 1800);
export const mega = fluidType(21, 45, 300, 1800);
export const kilo = fluidType(20, 40, 300, 1800);
