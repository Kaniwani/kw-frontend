...
const LayoutWrapper = styled.div`
  ${gutter({ type: 'outer', mod: 2 })} display: flex;
  width: 100%;
  height: 100%;
  flex: 1 0 100%;
    ...
    <SvgWrapper>
      ...
      >
        ...
        <path
          id="pinkClawStep1"
          fill="#f36353"
          d="M135 155c1.3 1.7 0 6.3 0 6.3h-6.3v6.2h-12.4v6.3h-12.5v6.2H85v-6.3H72.5v-12.4h6.3V155H85v-6.3h6.3v-6.2S126 143 135 155zm-43.8 15.6v-3H85v6.2h6.3zm0-28h6.3z"
        />
        ...
        <path
          id="clawLegsDarkStep1"
          fill="#9a4017"
          d="M235 164.4v-3.2h6.3V155h6.2v-6.3h6.3v18.8H235zm-37.5-15.7v-12.4h6.3v6.2h12.4V155H210v6.3h-12.5zM41.2 152v-3.2h6.3v-12.6h6.3V130H60v-12.5h-6.3v-6.3h12.5V105H85v6.3h6.3v6.2h6.2v6.3h6.3v6.2h12.5v6.3h-25v6.2H78.8v6.3H66.3v6.2h-25zm112.5-12.6v-3.2h-12.4v-18.6h25v18.7H160v6.2h-6.3z"
        />
        <path
          id="clawLegsDarkStep2"
          opacity="0"
          fill="#9a4017"
          d="M241.2 161.2V155h6.3v-6.3h6.2v18.8h-12.5zm-193.7-3V155h6.2v-6.3H60v-25h-6.3v-6.2h12.5v-6.3h12.5V105h12.5v12.5h6.3v6.2h6.2v6.3h12.5v6.2H110v6.3H97.5v6.2H78.7v6.3H66.2v6.2H47.5zm150-9.5v-12.5h6.2v6.3h12.5v18.7h-18.7zm-43.8-9.3v-3.2h-12.5v-18.7h25v18.7H160v6.3h-6.3z"
        />
        <path
          id="eyeNose"
          fill="#3f6533"
          d="M60 70.6v-3h-6.3v-6.3H60v6.2h31.3v6.3H60v-3.2zM41.2 58v-3h6.3v6.3h-6.3V58zM28.8 45.7v-3H35v6h-6.3v-3zm62.5-6.2v-3.2h6.3v6.3h-6.3v-3z"
        />
      </WalkingCrabigator>
    </SvgWrapper>
  </LayoutWrapper>
