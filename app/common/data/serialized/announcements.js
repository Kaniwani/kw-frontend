export default {
  "0": {
    ...
    "body": "<p>Adding Microsoft IME support caused an issue for some users with mobile keyboards that offer autocomplete suggestions. This caused them to block auto-converting from en -> kana. This is now remedied!</p>",
    "pubDate": "2017-08-06T09:09:10.082023Z",
    "creator": "Subversity"
  },
  "1": {
    "title": "Microsoft IME Fixed",
    "body": "<p>There were some residual issues with input via the Microsoft IME, mainly regarding ‘tt’ -> ‘っ’.  These have now been fixed. If you notice any changes or new issues arising with input, please let us know. </p>",
    "pubDate": "2017-08-02T17:33:45.432691Z",
    "creator": "Subversity"
  },
  "2": {
    "title": "Quoted Synonyms Update",
    "body": "<p>The annoying \"quoted synonyms\" are now filtered out in the review. Everybody dance!</p>",
    "pubDate": "2017-06-20T19:57:19.596753Z",
    "creator": "Subversity"
  },
  "3": {
    "title": "Quoted Synonyms",
    "body": "<p>Recent changes to WK's API now causes (unintentionally!) synonyms containing a space within them to be enclosed with double quotes. This is clearly quite annoying. We are going to wait on WK briefly to see if they will fix this first before we go ahead with our own fix (that we would then have to revert).</p><p>Please bear with us for a few days while we await a response from WK.</p>",
    "pubDate": "2017-06-18T11:15:36.483755Z",
    "creator": "Subversity"
  },
  "4": {
    "title": "Vacation Mode Hijinks",
    "body": "<p>Vacation Mode was playing up a little bit, letting reviews sneak through when it shouldn't have. This is working properly again now. Take as many vacations as you wish!</p>",
    "pubDate": "2017-06-09T09:53:44.243882Z",
    "creator": "Subversity"
  },
  "5": {
    "title": "HighLevel Users WK Sync (Fixed!)",
    "body": "<p>Batching sync updates is now working as expected. A few high level users might suddenly have some delayed burned WK items appear. <span lang=\"ja\">ごめんね！</span> Going forward, syncing should run as usual (within ~12 hours of WK changes).</p>",
    "pubDate": "2017-03-25T15:30:54.085051Z",
    "creator": "Subversity"
  },
  "6": {
    "title": "HighLevel Users WK Sync",
    "body": "<p>There is currently an issue affecting people with ~20 or more levels unlocked on KW. The WK api seems to be choking on requests for vocabulary that exceed a certain size.</p>\r\n<p>Unfortunately this is not something we can change from our end. However we are implementing a fix to query api data in batches to workaround the timeout issue</p>\r\n<p>We have a bug opened for it <a href=\"https://github.com/Kaniwani/KW-Backend/issues/298\" target=\"_blank\" rel=\"nofollow noreferrer noopener\">here</a>, feel free to add your KW username in that ticket if you are a KW user with >20 levels unlocked and your stuff isn't properly syncing.</p>",
    "pubDate": "2017-03-20T14:10:55.403057Z",
    "creator": "Subversity"
  },
  "7": {
    "title": "Changes for people with many reviews",
    "body": "Some users (with large amounts of reviews) were getting an error when trying to visit the review page. This patch breaks reviews down into 300 review chunks. This is just an interim fix, as we have something much larger in the works!\r\n\r\nCheers,",
    "pubDate": "2016-12-17T19:00:03.832425Z",
    "creator": "Tadgh"
  },
  "8": {
    "title": "Syncing New Vocab",
    "body": "<p>We're having a few problems with syncing new data at the moment, the user base is increasing and adding additional load to the server. We're working on remedying the issue, in the meantime you'll have to wait until it is resolved for newly unlocked items to come across automatically (but you can continue reviewing your present items without issue).</p>\r\n<p>If you are having trouble seeing new items appear, you can navigate to <a href=\"https://kaniwani.com/kw/sync\">kaniwani.com/kw/sync</a> to force a sync outside of the usual schedule. Please refrain from spamming this though!</p>",
    "pubDate": "2016-11-07T10:42:40.449654Z",
    "creator": "Subversity"
  },
  "9": {
    "title": "Stuck Review Item",
    "body": "<p>We're aware of some users having a single item repeating/remaining at the end of their review. We're attempting to isolate the problem, however we cannot seem to replicate the issue at all.</p>\r\n<p>Please bear with us in the meantime - if you get stuck, you can exit your review and see your current summary by clicking the eject icon at the top left of the review screen.</p>",
    "pubDate": "2016-09-24T04:32:01.362144Z",
    "creator": "Subversity"
  },
  "10": {
    "title": "Minor Updates",
  ...
  "12": {
    ...
    "pubDate": "2016-09-02T08:46:23.611080Z",
    "creator": "Subversity"
  },
  "13": {
    ...
    "pubDate": "2016-08-16T08:48:29.521929Z",
    "creator": "Subversity"
  },
  "14": {
    ...
    "pubDate": "2016-08-09T01:22:01.387085Z",
    "creator": "Subversity"
  },
  "15": {
    ...
    "pubDate": "2016-07-14T13:38:06.385869Z",
    "creator": "Tadgh"
  },
  "16": {
    "title": "Minor Bug - Review Countdown",
    "body": "<p>A few people are experiencing a bug where the Reviews button on the home page won't show \"Next Review: in x time\" and instead shows the loading icon (if there are no reviews ready).</p>\r\n<p>Reviews will still work as usual - you'll just have to check back to see if they're ready. The \"Next Hour\" count will give you an idea if anything is coming up soon. Sorry for the inconvenience!</p>",
    "pubDate": "2016-07-13T05:08:25.864614Z",
    "creator": "Subversity"
  },
  "17": {
    ...
    "pubDate": "2016-07-07T13:57:04.066224Z",
    "creator": "Tadgh"
  }
}